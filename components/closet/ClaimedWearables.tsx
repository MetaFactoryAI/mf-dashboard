...
import { Grid, GridItem, VStack, Spacer, Flex, Text, Box } from "@chakra-ui/react";
...
const ClaimedWearables: NextPage = () => {
  ...
  return (
    <VStack spacing="0px">
      <Box background='url("/closet_bckg.png") no-repeat center' backgroundSize="contain" width="100%" p="20px">
