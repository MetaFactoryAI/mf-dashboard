    ...
    <VStack p="4">
      <Box mb="8">
        ...
        >
          ...
          <path
            d="M203.067 98.4444V135.378H196.933V98.4444H178.444V141.556H184.622V104.622H190.755V141.556H209.244V104.622H215.378V141.556H221.555V98.4444H203.067Z"
            fill="white"
          />
          ...
          <path
            d="M356.607 32C356.607 33.8824 355.071 35.418 353.189 35.418C351.307 35.418 349.771 33.8824 349.771 32"
            fill="black"
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M352.281 32C352.281 32.4962 352.692 32.9081 353.189 32.9081C353.685 32.9081 354.097 32.4962 354.097 32H359.116C359.116 35.2685 356.457 37.9279 353.189 37.9279C349.92 37.9279 347.261 35.2685 347.261 32H352.281Z"
            fill="black"
          />
          <path
            d="M370.328 32C370.328 33.8824 368.792 35.418 366.91 35.418C365.028 35.418 363.492 33.8824 363.492 32"
            fill="black"
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M366.002 32C366.002 32.4962 366.414 32.9081 366.91 32.9081C367.406 32.9081 367.818 32.4962 367.818 32H372.838C372.838 35.2685 370.179 37.9279 366.91 37.9279C363.642 37.9279 360.982 35.2685 360.982 32H366.002Z"
            fill="black"
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M377.164 32.1376H342.886V28.7911H377.164V32.1376Z"
            fill="black"
          />
